...
class MyTestCase(unittest.TestCase):
    def test_isFinalDir(self):
        ...
        self.assertTrue(isFinalDir("C:\\Users\\User\\Desktop\\Software-Engineering-2020\\1-10\\001\\Masks\\Mask1\\FrontBack"))
    ...
    def test_allInputFilesArePng(self):
        ...
        for root, dirs, files in os.walk("C:\\Users\\User\\Desktop\\Software-Engineering-2020\\1-10\\001\\Masks\\Mask1\\TopBottom"):
            for file in files:
                if file.endswith(".png"):
                    third = third + 1
        nr1 = len(os.listdir("C:\\Users\\User\\Desktop\\Software-Engineering-2020\\1-10\\001\\Masks\\Mask1\\FrontBack"))
