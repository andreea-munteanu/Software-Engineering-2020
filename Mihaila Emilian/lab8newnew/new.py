...
# getting the data
TRAIN_DIR = 'G:\\IP_an2\\lab8newnew\\train'
TEST_DIR = 'G:\\IP_an2\\lab8newnew\\test1'
IMG_SIZE = 50
LR = 1e-3
...
def label_img(img):
    ...
    # conversion to one array [cat,dog]
...
with open('submission_file.csv', 'a') as f:
    for data in tqdm(test_data):
        ...
        f.write('{},{},{}\n'.format(img_num, model_out[1], ' How much the person is infected'))
